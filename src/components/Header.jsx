    ...
    <div className='w-full flex flex-col lg:flex-row px-4 md:px-10 gap-10 2xl:gap-20 py-20'>
      ...
      >
        ...
        <div className='flex gap-4 items-center my-4'>
          ...
          <div className='flex items-center justify-center text-black shadow-lg bg-orange-300 dark:bg-[#224cff10] dark:text-orange-300 rounded-full'>
        ...
        <div className='mt-10 flex gap-10'>
          <button className='bg-orange-300 text-lg text-white font-semibold rounded-md py-3 px-5'>
            Hire Me
          </button>
          <a href='#projects'>
